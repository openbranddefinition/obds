...
| [`OBDS-1.1.6-IMPLEMENTER-QUICKSTART.md`](OBDS-1.1.6-IMPLEMENTER-QUICKSTART.md) | five concepts, then the smallest conforming implementation |
| [`OBDS-1.1.6.md`](OBDS-1.1.6.md) | the normative specification |
...
| [`OBDS-1.1.6-TEST-RESULT.json`](OBDS-1.1.6-TEST-RESULT.json) | the verified conformance result |

Also: [`CONTRIBUTING.md`](CONTRIBUTING.md) for how to propose a change,
[`OBDS-1.1.6-CHANGELOG.md`](OBDS-1.1.6-CHANGELOG.md) for what moved and what did
not, [`OBDS-1.1.6-MIGRATION.md`](OBDS-1.1.6-MIGRATION.md) if you are on an
earlier release.
...
across 1.0.0, 1.0.1, 1.0.2, 1.0.3, 1.0.4, 1.1.0, 1.1.1, 1.1.2, 1.1.3, 1.1.4, 1.1.5 and 1.1.6, and the release gate fails
...
Seven suites: foundation 173, context-delivery 3, context-assembly 24,
...
Its result is published as `OBDS-1.1.6-FOUNDATION-CONFORMANCE.json`, and
...
279 would double-count the same coverage. The one case that is not duplicated,
...
modules other than the reference compiler. `OBDS-1.1.6-TEST-RESULT.json`
...
OBDS 1.1.6, stable, 1 September 2026. Published at
