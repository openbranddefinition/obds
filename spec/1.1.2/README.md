...
| [`OBDS-1.1.2-IMPLEMENTER-QUICKSTART.md`](OBDS-1.1.2-IMPLEMENTER-QUICKSTART.md) | five concepts, then the smallest conforming implementation |
| [`OBDS-1.1.2.md`](OBDS-1.1.2.md) | the normative specification |
...
| [`OBDS-1.1.2-TEST-RESULT.json`](OBDS-1.1.2-TEST-RESULT.json) | the verified conformance result |

Also: [`CONTRIBUTING.md`](CONTRIBUTING.md) for how to propose a change,
[`OBDS-1.1.2-CHANGELOG.md`](OBDS-1.1.2-CHANGELOG.md) for what moved and what did
not, [`OBDS-1.1.2-MIGRATION.md`](OBDS-1.1.2-MIGRATION.md) if you are on an
earlier release.
...
Seven suites: foundation 75, context-delivery 3, context-assembly 15,
design-space 18, integration 15, golden 6, adversarial 33. No `skipif`, no
...
Its result is published as `OBDS-1.1.2-FOUNDATION-CONFORMANCE.json`, and
...
165 would double-count the same coverage. The one case that is not duplicated,
...
modules other than the reference compiler. `OBDS-1.1.2-TEST-RESULT.json`
