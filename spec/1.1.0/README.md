...
| [`OBDS-1.1.0-IMPLEMENTER-QUICKSTART.md`](OBDS-1.1.0-IMPLEMENTER-QUICKSTART.md) | five concepts, then the smallest conforming implementation |
| [`OBDS-1.1.0.md`](OBDS-1.1.0.md) | the normative specification |
...
| [`OBDS-1.1.0-TEST-RESULT.json`](OBDS-1.1.0-TEST-RESULT.json) | the verified conformance result |

Also: [`CONTRIBUTING.md`](CONTRIBUTING.md) for how to propose a change,
[`OBDS-1.1.0-CHANGELOG.md`](OBDS-1.1.0-CHANGELOG.md) for what moved and what did
not, [`OBDS-1.1.0-MIGRATION.md`](OBDS-1.1.0-MIGRATION.md) if you are on an
earlier release.
...
across 1.0.0, 1.0.1, 1.0.2, 1.0.3, 1.0.4 and 1.1.0, and the release gate fails
...
Seven suites: foundation 43, context-delivery 3, context-assembly 15,
...
Its result is published as `OBDS-1.1.0-FOUNDATION-CONFORMANCE.json`, and
...
123 would double-count the same coverage. The one case that is not duplicated,
`canonical-hashes`, pins the canonical hashing of the published
`examples/simple` manifest and its compiled artefact.
...
modules other than the reference compiler. `OBDS-1.1.0-TEST-RESULT.json`
...
OBDS 1.1.0, stable, 30 August 2026. Published at
