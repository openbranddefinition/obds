...
## 32. How the open project is governed

For OBDS to operate as an open standard:
...
- reference tooling is open where practical;
...
- schemas, fixtures and reference software: Apache License 2.0.
...
1. one normative specification: `OBDS-1.0.0.md`;
...
There is no `OBDS-CORE-1.0.0.md`. Foundation semantics live in the main specification.
