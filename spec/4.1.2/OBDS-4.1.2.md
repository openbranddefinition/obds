...
### Optional Task Facts 1.0 evaluator capability

OBDS 4.1.0 adopts the complete Task Facts normative requirements materialised in section 35 of this single specification, together with the identified structural schema. The unchanged non-root proposal copies are provenance and evidence, not independently authoritative specifications. This isolated candidate is prospective until publication.

The optional runtime capability `task-facts` is separately claimed under section 26.10. Existing Foundation and other capability claims MUST NOT require installation, schema lookup, preflight or invocation of this evaluator. Existing valid 4.0.4 packages require no migration. No manifest, Build Plan, MIP, RDR, build-report, governed hash or compiled runtime behavior changes. There is no production integration conformance claim.
...
### 26.10 OBDS Task Facts 1.0 evaluator

The separately optional `task-facts` claim MUST implement all normative requirements in section 35, including complete contract prose and the identified schema. It MUST identify implementation/version, exact adopted contract/schema raw hashes, payload 0.1, TFJ-0.1 and `task-facts-1.0` suite revision 1 plus its derived suiteHash. The [runner contract](reference/task-facts/1.0/RUNNER-CONTRACT.md) defines suite identity and results metadata.

Full claimants MUST pass every ordered six-field comparison: 66 fixture decisions and 36 regression records, zero skips or xfails. Partial or schema-only support MUST NOT claim full Task Facts conformance. Capability availability does not claim reference compiler support. This is not Foundation, Compiled Runtime, certification or production integration conformance. Existing claims remain unchanged when Task Facts is absent.
...
1. one normative specification: `OBDS-4.1.2.md`;
...
## 35. Optional Task Facts 1.0 normative requirements

This section materialises the complete ratified contract (all source sections 1-8), normative delta and conformance requirements. It is part of the single current normative specification. The optional `task-facts` capability and section 26.10 claims remain unchanged. The source documents retained under `reference/task-facts/1.0/contract/` and in the ratification evidence are byte-identical provenance, not additional independently authoritative specifications.

For the identified normative requirements below, adoption supersedes only source wording that calls their adoption proposed, experimental, pending or non-normative. This candidate remains prospective until authorised publication. All definitions, algorithms and requirements in the complete contract, all normative delta obligations, and the proposed normative requirements in the conformance impact are adopted here. Examples, research and hypothetical-host discussion, supporting evidence and historical claims remain informative. No production adapter conformance is established.

Source section numbers and intra-contract section references below are local to the reproduced contract. Its `schemas/task-facts.schema.json` denotes the unchanged structural schema at `reference/task-facts/1.0/contract/schemas/task-facts.schema.json`, also distributed byte-identically at `reference/task-facts/1.0/schemas/task-facts.schema.json`. Other source-relative artifact references resolve from the retained source location. Headings are demoted for nesting and en/em dashes are rendered as ASCII hyphens to preserve this specification's presentation convention; no requirement text is otherwise changed. Raw SHA-256 identities identify the unchanged source bytes, not this presentation.

### 35.1. TASK-FACTS-CONTRACT.md

Source: [retained ratified TASK-FACTS-CONTRACT.md](reference/task-facts/1.0/contract/TASK-FACTS-CONTRACT.md); raw SHA-256 `a92b5a1de66365c81543d939d104975c5ee139d6b7396f532bbd0a1163014046`.

<!-- task-facts-source:TASK-FACTS-CONTRACT.md:begin -->
...
<!-- task-facts-source:TASK-FACTS-CONTRACT.md:end -->

### 35.2. NORMATIVE-DELTA.md

Source: [retained ratified NORMATIVE-DELTA.md](reference/task-facts/1.0/contract/NORMATIVE-DELTA.md); raw SHA-256 `00558367da90281fff8bcfe53e9356ff5190b9f8072d9247205608c7bac21589`.

<!-- task-facts-source:NORMATIVE-DELTA.md:begin -->
...
<!-- task-facts-source:NORMATIVE-DELTA.md:end -->

### 35.3. CONFORMANCE-IMPACT.md

Source: [retained ratified CONFORMANCE-IMPACT.md](reference/task-facts/1.0/contract/CONFORMANCE-IMPACT.md); raw SHA-256 `fe12b7413fa397b7e2a93f2a2a3474fa4b105d2fe3e1199276ba83f53d87b6f8`.

<!-- task-facts-source:CONFORMANCE-IMPACT.md:begin -->
#### Conformance impact
...
<!-- task-facts-source:CONFORMANCE-IMPACT.md:end -->
