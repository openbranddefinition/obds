...
| [`OBDS-4.0.4-IMPLEMENTER-QUICKSTART.md`](OBDS-4.0.4-IMPLEMENTER-QUICKSTART.md) | five concepts, then the smallest conforming implementation |
| [`OBDS-4.0.4.md`](OBDS-4.0.4.md) | the normative specification |
...
| [`OBDS-4.0.4-TEST-RESULT.json`](OBDS-4.0.4-TEST-RESULT.json) | the verified conformance result |

Also: [`CONTRIBUTING.md`](CONTRIBUTING.md) for how to propose a change,
[`OBDS-4.0.4-CHANGELOG.md`](OBDS-4.0.4-CHANGELOG.md) for what moved and what did
not, [`OBDS-4.0.4-MIGRATION.md`](OBDS-4.0.4-MIGRATION.md) if you are on an
earlier release.
...
across 1.0.0, 1.0.1, 1.0.2, 1.0.3, 1.0.4, 1.1.0, 1.1.1, 1.1.2, 1.1.3, 1.1.4, 1.1.5, 1.1.6, 2.0.0, 3.0.0, 3.0.1, 3.0.2, 3.0.3, 3.0.4, 4.0.0, 4.0.1, 4.0.2, 4.0.3 and 4.0.4, and the release gate fails
...
Its result is published as `OBDS-4.0.4-FOUNDATION-CONFORMANCE.json`, and
...
modules other than the reference compiler. `OBDS-4.0.4-TEST-RESULT.json`
...
OBDS 4.0.4, stable, 6 September 2026. Published at
