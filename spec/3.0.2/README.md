...
| [`OBDS-3.0.2-IMPLEMENTER-QUICKSTART.md`](OBDS-3.0.2-IMPLEMENTER-QUICKSTART.md) | five concepts, then the smallest conforming implementation |
| [`OBDS-3.0.2.md`](OBDS-3.0.2.md) | the normative specification |
...
| [`OBDS-3.0.2-TEST-RESULT.json`](OBDS-3.0.2-TEST-RESULT.json) | the verified conformance result |

Also: [`CONTRIBUTING.md`](CONTRIBUTING.md) for how to propose a change,
[`OBDS-3.0.2-CHANGELOG.md`](OBDS-3.0.2-CHANGELOG.md) for what moved and what did
not, [`OBDS-3.0.2-MIGRATION.md`](OBDS-3.0.2-MIGRATION.md) if you are on an
earlier release.
...
across 1.0.0, 1.0.1, 1.0.2, 1.0.3, 1.0.4, 1.1.0, 1.1.1, 1.1.2, 1.1.3, 1.1.4, 1.1.5, 1.1.6, 2.0.0, 3.0.0, 3.0.1 and 3.0.2, and the release gate fails
...
Its result is published as `OBDS-3.0.2-FOUNDATION-CONFORMANCE.json`, and
...
modules other than the reference compiler. `OBDS-3.0.2-TEST-RESULT.json`
...
OBDS 3.0.2, stable, 4 September 2026. Published at
